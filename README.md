...
- **GRADATE** [^8] adopts random edge modifications as an augmentation strategy and introduces subgraph-subgraph instance pairs into the GAD problem. Source code: [https://github.com/FelixDJC/GRADATE]([https://github.com/pygod-team/pygod](https://github.com/FelixDJC/GRADATE)
